...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<selenium-webdriver>.freeze, ["~> 3.4", ">= 3.4.1"])
      ...
      s.add_development_dependency(%q<webdrivers>.freeze, ["= 3.4.1"])
      ...
      s.add_dependency(%q<selenium-webdriver>.freeze, ["~> 3.4", ">= 3.4.1"])
      ...
      s.add_dependency(%q<webdrivers>.freeze, ["= 3.4.1"])
