class ModifyValorPesoToClients < ActiveRecord::Migration[5.0]
  def up
  	...
  	change_column :clients, :valor_peso_1500, :decimal, :precision => 10, :scale => 3
  end
  ...
  def down
  	...
  	change_column :clients, :valor_peso_1500, :decimal, :precision => 10, :scale => 2
  end
end
