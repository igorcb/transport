...
RSpec.describe DepositsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      deposit = Deposit.create! valid_attributes
      get :edit, params: {id: deposit.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested deposit" do
        deposit = Deposit.create! valid_attributes
        put :update, params: {id: deposit.to_param, deposit: new_attributes}, session: valid_session
        deposit.reload
      ...
      it "redirects to the deposit" do
        deposit = Deposit.create! valid_attributes
        put :update, params: {id: deposit.to_param, deposit: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        deposit = Deposit.create! valid_attributes
        put :update, params: {id: deposit.to_param, deposit: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
