  ...
  private
    ...
    def client_table_price_params
      params.require(:client_table_price).permit(:client_id, :type_service_id, :stretch_route_id,
        :freight_weight, :freight_value, :freight_volume, :freight_dispatch, :freight_toll, :freight_type_gris, :freight_gris, :freight_type_trt, :freight_trt, :payment_discharges,
