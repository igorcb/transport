class Ability
  ...
  def initialize(user)
    ...
    if user.has_role? :admin
      ...
      #can :manage, Client
      can :manage, [Boarding, OrdemService, Driver, Task, InternalComment, Link, Comment, Breakdown]
      ...
      can :manage, [InputControl, NfeXml, NfeKey, OrdemService, Driver, Product, Link, Comment, Breakdown, Task, InternalComment, ControlPallet]
      can :manage, [Boarding]
