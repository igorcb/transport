class Task < ActiveRecord::Base
  ...
  belongs_to :employee, class_name: "User", foreign_key: "employee_id", required: false
  belongs_to :second_employee, class_name: "User", foreign_key: "second_employee_id", required: false
