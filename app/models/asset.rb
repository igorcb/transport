class Asset < ActiveRecord::Base
	belongs_to :task, class_name: "Task", foreign_key: "asset_id", polymorphic: true, dependent: :destroy
	...
	belongs_to :promoter, class_name: "Promoter", foreign_key: "asset_id", polymorphic: true, dependent: :destroy
	...
	belongs_to :meeting, class_name: "Meeting", foreign_key: "asset_id", polymorphic: true, dependent: :destroy
